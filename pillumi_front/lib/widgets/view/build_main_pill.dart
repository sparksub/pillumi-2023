...
Column BuildMainPill(Pill mainPill) {
  return Column(
    children: [
      ...
      Column(
          children: [
            (mainPill.efficacy.toString().trim() != "nan")
                ? buildPillInfoCard(
                '효능효과',
                mainPill.efficacy.toString()
            ):Container(),
            (mainPill.dosage.toString().trim() != "nan")
                ? (
            ...
            (mainPill.atpnWarnQesitm.toString().trim() != "nan")
                ? (
            ...
            (mainPill.atpnQesitm.toString().trim() != "nan")
                ? (
            ...
            (mainPill.intrcQesitm.toString().trim() != "nan")
                ? (
            ...
            (mainPill.seQesitm.toString().trim() != "nan")
                ? (
            ...
            (mainPill.depoditMetodQesirm.toString().trim() != "nan")
                ? (
